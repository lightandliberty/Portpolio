...
//            ButtonColor = KeyColor.Gray3;
        ...
        public void InitNeonPairs()
        {
            ...
            List<NeonColors> colorList = new List<NeonColors>()
            {
                ...
                new NeonColors(KeyColor.Yellow, Color.FromArgb(249, 250, 000), Color.FromArgb(183, 156, 000), Color.FromArgb(254, 254, 252)),
                //new NeonColors(KeyColor.Yellow, Color.FromArgb(249, 250, 000), Color.FromArgb(183, 156, 000), Color.FromArgb(253, 249, 176)),
